class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.01"
    sha256 cellar: :any, arm64_sequoia: "7f0d653800eaff767acb992f299242f5068ba0a9144d27966825b0f1a0b70d6c"
    sha256 cellar: :any, arm64_sonoma:  "ac05750a42bd569f113b8a174577ce8f811a1717dc6d3d6b3d1868739ec25c0a"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/f66d2a1802d9e04a57441160f411d46be63d785f.tar.gz"
    sha256 "8d450bbef5f9b4f5038611390e46c32e356f3bed5cc7ea6c8107737588ccd650"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260801\n"
    (libexec/"IDRIS2_COMMIT").write "f66d2a1802d9e04a57441160f411d46be63d785f\n"
