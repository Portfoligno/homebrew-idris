class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.06"
    sha256 cellar: :any, arm64_sequoia: "88d9897a990977230ddbc4d9ab2ade444419bb2f0f2feeb67bc463f38ba0991b"
    sha256 cellar: :any, arm64_sonoma:  "ab9cf6e7d92f60460f92b1bfbc59c8f1f72ec8ed8acbd000c83df9797c0299fd"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260606\n"
