class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.24"
    sha256 cellar: :any, arm64_sequoia: "395366eccd1de72d60a39d86cfe8dc0bbbb5d0bc89328d16d86a2246aa9a259d"
    sha256 cellar: :any, arm64_sonoma:  "c01a777d39c8712e1b1b90bc95ea4ff5474638c95c4850eab3370cff933d51d9"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260724\n"
