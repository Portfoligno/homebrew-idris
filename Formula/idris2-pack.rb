class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.22"
    sha256 cellar: :any, arm64_sequoia: "9a775008fa043580091bc24dbca096257569d465662f93d8126803e119fe10c3"
    sha256 cellar: :any, arm64_sonoma:  "c581ff4c0e2fcf16f5dc43c9dd60db2fbfd75b8dc19e2736ce9e9f7a6d712935"
  end
  ...
  resource "idris2-array" do
    url "https://github.com/stefan-hoeck/idris2-array/archive/41a001cd6d8d1ba394d875dedfeae56183a64bd1.tar.gz"
    sha256 "26de47f27bc150d445803960571447a47ddf9ce74a665929a4e74cbb9d103ceb"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/4e6b10e099b9947f340054c78f4aed3e17ffd148.tar.gz"
    sha256 "f17fc0048f9e5cc8649993fddbb40b3d2d6bfd1bffd5f4992197b3cec80aac6f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260722\n"
