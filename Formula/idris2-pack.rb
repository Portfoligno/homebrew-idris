class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.24"
    sha256 cellar: :any, arm64_sequoia: "7b17b51f2c3d620f88191a4e5f6b141b24167ec8cefbc60906d75c05e685e91e"
    sha256 cellar: :any, arm64_sonoma:  "4ef9e443ec38ee90be3e3d2314e3826bf6cfe4c07fdff51ec155f375774b8514"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/4e62000b29b837da4d21070dd4200459482c1800.tar.gz"
    sha256 "684c05f32d001967237424399489a7b3594386bcb896d59f8836ab353cdab8f6"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260824\n"
    (libexec/"IDRIS2_COMMIT").write "4e62000b29b837da4d21070dd4200459482c1800\n"
