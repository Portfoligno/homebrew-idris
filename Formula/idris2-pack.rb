class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.18"
    sha256 cellar: :any, arm64_sequoia: "af2f2906dd59e15f7738ab8b5697004a205165c115899470922ec1a38f607c50"
    sha256 cellar: :any, arm64_sonoma:  "c8cdc21484372f9790ddb83371f26bd3e8df136ae71df7cba07db6442852cf9d"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260718\n"
