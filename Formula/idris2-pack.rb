class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.09"
    sha256 cellar: :any, arm64_sequoia: "dfc4d2c0e0835b0b4995e5ac8a3daeb92de42a39034471ecb97426e3cdebdae3"
    sha256 cellar: :any, arm64_sonoma:  "b032b6ba5659e23534e03dec2a909d54b4ea7dfbc13333b410804923c1bbda0f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260809\n"
