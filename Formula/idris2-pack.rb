class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.28"
    sha256 cellar: :any, arm64_sequoia: "74f847f70cdaeb5d4a47312abeaddc49c5f4e281369c2f0980dd6160ed57f6e2"
    sha256 cellar: :any, arm64_sonoma:  "9d6b8f0b208e169369cb1f2fce818dec36d4281271fc506e09c6f78b92719aff"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/d2559fea0eb4cfb633ba6719b9c99d3f54b3563b.tar.gz"
    sha256 "09d57a1bda3c92aef11ddd2de2c8e83b0829b6f89ec0e2b32acea4307d337632"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260728\n"
    (libexec/"IDRIS2_COMMIT").write "d2559fea0eb4cfb633ba6719b9c99d3f54b3563b\n"
