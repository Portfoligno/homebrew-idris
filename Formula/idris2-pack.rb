class Idris2Pack < Formula
  ...
  url "https://github.com/stefan-hoeck/idris2-pack/archive/846a90d76d1d4c451484eb09773f11a9e2fd58f2.tar.gz"
  version "2026.09.01"
  sha256 "39e199e76dc101b770899824ed00265a5b0283ed4202324c3827fd41fd12cda0"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.01"
    sha256 cellar: :any, arm64_sequoia: "60ce366167eadf906c9478abbeb663ef5685aade854612d843ac1e01a123c5ad"
    sha256 cellar: :any, arm64_sonoma:  "7cd5aaab1f80ed9af6b76dd9311d29e72ab51c1e66095c0f1e91ec5e55bd49dd"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/74b33730b6fea649b15e8d01ab099df9effcc7a0.tar.gz"
    sha256 "c1c5264f59c964a3afc576f1594f1f5bae89cf0a8991b21861a39b69f698f356"
  end
  ...
  resource "idris2-ref1" do
    url "https://github.com/stefan-hoeck/idris2-ref1/archive/7ababaeb9dfd88aaf80a342ac93a6b50e58f485d.tar.gz"
    sha256 "df6720a857058b5182e697c781fda52b8f97cabac076ee7e2d0e1edbe76ca679"
  end

  resource "idris2-array" do
    url "https://github.com/stefan-hoeck/idris2-array/archive/4ac233d439239b18dc9f1d755c3a4fd22c2c7cc3.tar.gz"
    sha256 "29fabe8ab1f7f8cac9e6cff2317545efb1a59423a629f74f43892cbb8d0c5875"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/35300916952f92912f8b4894f73da7be9b4b805a.tar.gz"
    sha256 "45f967d9d82d23c6c413eb20a2bc528636609c8cea74ff9832e7bf6c77bfb2d5"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260901\n"
    (libexec/"IDRIS2_COMMIT").write "74b33730b6fea649b15e8d01ab099df9effcc7a0\n"
