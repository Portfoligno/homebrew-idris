class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.05"
    sha256 cellar: :any, arm64_sequoia: "b45626d8c9cbfc5af7b4312034d7eb21ae82c58395e7da81c56497288a86972b"
    sha256 cellar: :any, arm64_sonoma:  "ecbc4398eea72280d9b747250c4f04e88ecf1ca5937078b37230fec8d3c8a238"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260805\n"
