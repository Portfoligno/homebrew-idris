class Idris2Pack < Formula
  ...
  url "https://github.com/stefan-hoeck/idris2-pack/archive/d126fbe908825517a01c91c8aa3e4b4048e6ddc3.tar.gz"
  version "2026.07.27"
  sha256 "5d317691f8f107f2fa50188b707b6e13876aada87de88e79b3eec691c16ce438"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.27"
    sha256 cellar: :any, arm64_sequoia: "d81802fe597bd767bb40284f32e82a330a236546e6b3b1ef4f2144862dfa3e3e"
    sha256 cellar: :any, arm64_sonoma:  "35d96e419a93d942b334aa54ab6f39cfb4f545da2adc8f265cd6371ff4ec7c46"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260727\n"
