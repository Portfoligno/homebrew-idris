class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.15"
    sha256 cellar: :any, arm64_sequoia: "e1f82bac6b22d029b0fd58214896d7a9d564607a5f7e067d658e612b056ec7f7"
    sha256 cellar: :any, arm64_sonoma:  "35d367a344ef86377fd4f52385289cdfdeb52a4d8cbafdf32f20040b23d0f22c"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260715\n"
