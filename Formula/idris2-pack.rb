class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.08"
    sha256 cellar: :any, arm64_sequoia: "57832e65384e8c61e1b16151db5ef0f4303dd9d7ee2d0b998187110869927109"
    sha256 cellar: :any, arm64_sonoma:  "cce755fba3fae11afffc0459586a8dbc08a0b6a5b51a368ecd8e66d15897b566"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260808\n"
