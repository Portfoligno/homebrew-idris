class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.23"
    sha256 cellar: :any, arm64_sequoia: "f301f354952031b47203e6bb667235ea905364ca9409d71749c4ab4815be860a"
    sha256 cellar: :any, arm64_sonoma:  "7fd099c10c73c6157463ec418ad2cf1d5858fc08b51c4bfe703cc476dd3a1fb0"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260823\n"
