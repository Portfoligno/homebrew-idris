class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.07"
    sha256 cellar: :any, arm64_sequoia: "5ff356c2e27d3b34a9a4abfa862972588981e6fa8e04c3f80e16915b61f17b83"
    sha256 cellar: :any, arm64_sonoma:  "bac88fb0c3b371e1a37525346f357188c81c376f00b25bf5144f9cda6630798d"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/b51cac2d215c75ac1a05dddb7a2590695bc93d22.tar.gz"
    sha256 "944a515ddd68b9c92841481f02b0deffbdd9df0edc9153a172f8c93c345c34a0"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260807\n"
    (libexec/"IDRIS2_COMMIT").write "b51cac2d215c75ac1a05dddb7a2590695bc93d22\n"
