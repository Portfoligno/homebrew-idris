class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.23"
    sha256 cellar: :any, arm64_sequoia: "5e6f293bfd22bb48a8db098de8751ca06e6583d634c179634712be731b3b5dc7"
    sha256 cellar: :any, arm64_sonoma:  "88d9511357880b4a8893841d35ee0028108c13a7608f4ea4ba0b54d9a3a9f7e5"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/e5ddfca2b9f7846801edd89967442a01cfbbb618.tar.gz"
    sha256 "c1d840cb447d775db2acdc1f885e4247cb455859f7e47ef6fc5d82692334162f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260723\n"
