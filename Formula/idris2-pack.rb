class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.19"
    sha256 cellar: :any, arm64_sequoia: "4ef7f8f3158ec89b89823f55f20ba260c79966b3bcb60395473bba980100378d"
    sha256 cellar: :any, arm64_sonoma:  "ab17ef331384233d4580383764ce62e107c25e398affdaff1a17721a60a67a96"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260819\n"
