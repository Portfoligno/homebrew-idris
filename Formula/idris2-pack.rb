class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.17"
    sha256 cellar: :any, arm64_sequoia: "4c58fc4955abb23345ca091b066247deae4a7c82aa0d730e506a28a8c53368e0"
    sha256 cellar: :any, arm64_sonoma:  "89b478fd0ae1d27e9bc9122ae36593564bc0260ef89680bed6d6927671a6df54"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/0781ad17660531e0add4eb4a274d5406c5078005.tar.gz"
    sha256 "1f3268e87f55d22bca0475b988716515dd1818962aebf635ce4d1131cefd02ed"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260817\n"
    (libexec/"IDRIS2_COMMIT").write "0781ad17660531e0add4eb4a274d5406c5078005\n"
