class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.09"
    sha256 cellar: :any, arm64_sequoia: "be6a32cd058dada9dc4b527715820c885c7643261a11740326f916e921d91329"
    sha256 cellar: :any, arm64_sonoma:  "1bc0880d5e4420325c4885f834f9ffb17c9b34fef5c3d34ce4b274ca19c2c686"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260709\n"
