class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.05.30"
  ...
  resource "idris2-array" do
    url "https://github.com/stefan-hoeck/idris2-array/archive/9f7714fc6a75477c8009a03b6331eae4d51dae7b.tar.gz"
    sha256 "15828204db8d8f7e51503748cd9eaf27a48b43552ab454321dd597556c2b09e6"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260530\n"
