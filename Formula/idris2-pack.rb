class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.13"
    sha256 cellar: :any, arm64_sequoia: "6af137b1997d474ea50ef9cf17d11a24521f20ab219224932654038e6b330199"
    sha256 cellar: :any, arm64_sonoma:  "33990485caf20f838f8929c146d814c084f734dadc5ad32fd2868d043a0a5b2c"
  end
  ...
  resource "pack-dep-ilex-core" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/036c925ef849a13eaf308fda5459d11000540502.tar.gz"
    sha256 "904a34b1e16ed0bac6006d670476c1ec22e68837f9019cacb94926e789c325c7"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260913\n"
