class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.28"
    sha256 cellar: :any, arm64_sequoia: "998bdbbc95edd8b5f69466ca4fdeadd31f84ad8f858352f9ebe8815b76f31d7a"
    sha256 cellar: :any, arm64_sonoma:  "e2ed15bc914cdab28f5a8d78b4c7b0450da6e357c09e7f8cb68dd66d8e96ec58"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260628\n"
