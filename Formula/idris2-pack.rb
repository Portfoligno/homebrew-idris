class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.03"
    sha256 cellar: :any, arm64_sequoia: "9e424dbe330d2f54c0251508dcde07cc865ad19fc1acca06cca6bfa5d6db0455"
    sha256 cellar: :any, arm64_sonoma:  "d843498ab110f11f7cd3ceabcbd773716174bf577943582d2e253ae9a0eff4f8"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260703\n"
