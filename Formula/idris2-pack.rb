class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.18"
    sha256 cellar: :any, arm64_sequoia: "401cab779e3a03fb411eb04b5403855d4e558742c1c8deaedc31ceca26163f94"
    sha256 cellar: :any, arm64_sonoma:  "f8116bdf5b9276c7a5f192b51da5cbb779461c4cee4f7d4ecbe50092ae2f4b58"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/f7cf537e6d21b0bc3a3c5050e2e82aaec506b1a0.tar.gz"
    sha256 "2131508f7ea2ec16d9e1e7045dc84b370898afc3326960c945b06d85e84bb878"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260818\n"
    (libexec/"IDRIS2_COMMIT").write "f7cf537e6d21b0bc3a3c5050e2e82aaec506b1a0\n"
