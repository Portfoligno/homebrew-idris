class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.09"
    sha256 cellar: :any, arm64_sequoia: "5b5e51bdcf409396294da492d8d0ca7b41ebdb6a775410aa3073009b2efdb762"
    sha256 cellar: :any, arm64_sonoma:  "426e19e4706eab2a3e582c73f5a929c28f25e213a0a9dfbf6de44b1a8f1aaf81"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260609\n"
