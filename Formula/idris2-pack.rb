class Idris2Pack < Formula
  ...
  def install
    ...
    resource("idris2-ref1").stage do
      system idris2_bin, "--install", "docs/docs.ipkg"
      system idris2_bin, "--install", "profile/profile.ipkg"
    ...
    resource("idris2-refined").stage do
      system idris2_bin, "--install", "docs/docs.ipkg"
      system idris2_bin, "--install", "json/refined-json.ipkg"
      system idris2_bin, "--install", "refined.ipkg"
      system idris2_bin, "--install", "tsv/refined-tsv.ipkg"
    end
    ...
    resource("idris2-ilex").stage do
      ...
      system idris2_bin, "--install", "profile/profile.ipkg"
      system idris2_bin, "--install", "streams/ilex-streams.ipkg"
