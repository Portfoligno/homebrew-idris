class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.04.30"
    sha256 cellar: :any, arm64_sequoia: "0be1a4159981e5b462198b4cd8f7d79afadb6ebf4a6c22a2a6341a1f7709ccbc"
    sha256 cellar: :any, arm64_sonoma:  "ee3886ac591ce305ac181407a175be326e5a91667da5ffc67840e5d0e60d8923"
  end
  ...
  def install
    ...
    # Pack wrapper sets PATH only — IDRIS2_PREFIX is NOT exported here,
    # preventing it from leaking to pack's child processes.
