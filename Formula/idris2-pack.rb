class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.10"
    sha256 cellar: :any, arm64_sequoia: "414610dae455309176cbedd4bb58a9cc5d7fc8d410d5990f2519a051340682b3"
    sha256 cellar: :any, arm64_sonoma:  "bf72b88e23e83a13326198106586b0f0f4f9084714319f593b0b7d3676188f1b"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260810\n"
