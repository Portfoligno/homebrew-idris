class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.11"
    sha256 cellar: :any, arm64_sequoia: "59be0a36a228dd9cd34e5ecd6529620e2974b5a22ab7ede7400f2094cc9ad6d5"
    sha256 cellar: :any, arm64_sonoma:  "25da84f14f294f6618236f70dae55bd92f62780e2c41d053db89b4c49e748594"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/134412e1c8c0f793ed3cf8c3681280b13547ef83.tar.gz"
    sha256 "c47b63e462def0794f0d6d74ef8349274c92741bbd6e2ea644bc2ae58cafc00f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260811\n"
    (libexec/"IDRIS2_COMMIT").write "134412e1c8c0f793ed3cf8c3681280b13547ef83\n"
