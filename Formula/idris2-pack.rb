class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.08"
    sha256 cellar: :any, arm64_sequoia: "f7d8c211c581a1ae4eba870a594054d262a65689e0ba2663acd88ba33d4a510a"
    sha256 cellar: :any, arm64_sonoma:  "18c0b644505cf66d7c2e952ffda9161f359f22e70cc519edb045d54e3c2c159e"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260608\n"
