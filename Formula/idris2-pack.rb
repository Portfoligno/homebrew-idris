class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.30"
    sha256 cellar: :any, arm64_sequoia: "1ccaee490f9cea0f919a0f93326dde1ea202bb8c10c3a680857e2da610b3444a"
    sha256 cellar: :any, arm64_sonoma:  "715dfdf76c9b74ced06f26743d68da4326bd8773d81fa5e0cb1bc8a92a15a44f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260630\n"
