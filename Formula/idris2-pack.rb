class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.03"
    sha256 cellar: :any, arm64_sequoia: "318722901c8f75ca3605a9b2e4bb1c0282990bb4eebd5b6bf8e691478708c272"
    sha256 cellar: :any, arm64_sonoma:  "ec857b9cecb26776783484e7d51194379261406b6e04e9e3408f08070a70d5d2"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260803\n"
