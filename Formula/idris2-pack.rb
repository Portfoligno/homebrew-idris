class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.10"
    sha256 cellar: :any, arm64_sequoia: "b0a6b88c589f0d86b4c2e07f1934378c6ec562b00a65c6f49569991b3467e3d6"
    sha256 cellar: :any, arm64_sonoma:  "052540c5779ec6bd6229e5e0f5a243412ea1d580861940fa4da0856b7ab75896"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260710\n"
