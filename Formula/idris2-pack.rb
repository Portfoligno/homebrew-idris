class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.24"
    sha256 cellar: :any, arm64_sequoia: "ba27cf1b05cad5c59347049ad09a3c3582a40c3e2dddaa20a0f99350c44618c7"
    sha256 cellar: :any, arm64_sonoma:  "9db274f8e531114c601a2f4f3b12f7ceeec553bf3ac822a5fbd8197a121bdf65"
  end
  ...
  resource "pack-dep-ref1" do
    url "https://github.com/stefan-hoeck/idris2-ref1/archive/7c7f732504fe3a1453c0c02060307903af264ab5.tar.gz"
    sha256 "c8075923edab8a32a031f448b17e8de8a63d45e188b114752ee0e0f5f6bcb5a9"
  end
  ...
  resource "pack-dep-ilex-core" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/07af8b537a36892c7b22a559238bdfe1fc788d36.tar.gz"
    sha256 "6512edf516066671f54e6cef5049145b8a1004074639d0f144bc2aecd3442e41"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260924\n"
