class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.21"
    sha256 cellar: :any, arm64_sequoia: "6bfb0da93a5d3d1574408978628960bd51d0ec2ffb8ae5fedf0182d39162d840"
    sha256 cellar: :any, arm64_sonoma:  "0b9e482663a023745184c9c6f5f5dc20dd00c5ca7e3181ff9616f2faf809c154"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/73a3b7cf78c69abe2e8afcff896d5ee1bd41d55d.tar.gz"
    sha256 "31adf60736d943681cdb6f149761c602b6ba109b1cb11c62611f35305f0f509a"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260821\n"
    (libexec/"IDRIS2_COMMIT").write "73a3b7cf78c69abe2e8afcff896d5ee1bd41d55d\n"
