class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.14"
    sha256 cellar: :any, arm64_sequoia: "b4dbc2cc71a08f65d455883aed477e0736e368ecee70c1d346ad079813752165"
    sha256 cellar: :any, arm64_sonoma:  "da624b87f6eb6555681a3e48eed222b7e76b6bb8b58ff6c0858b3056bdb895fb"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/0b290e0be390e589e273f0344f7ecc630053f0d3.tar.gz"
    sha256 "4a2650ff2c4295aca05350b13bc8565546affbaee346ec2b63ba3dd9084039f2"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260614\n"
