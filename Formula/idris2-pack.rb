class Idris2Pack < Formula
  ...
  url "https://github.com/stefan-hoeck/idris2-pack/archive/0efdab5fbd086fa1005b57a94cec963909fd7fb4.tar.gz"
  version "2026.09.06"
  sha256 "6e44068ffa3f48b11381fe367d8daaabf630b5602f5e62548d3c4b9994f82fa3"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.06"
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/5aaefadb587224eb44d3be0fbb7e2835b48bd7a6.tar.gz"
    sha256 "b05e982313b7532be84f0482b808f222a2c5065a50d896690cce8f11a738753c"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260906\n"
    (libexec/"IDRIS2_COMMIT").write "5aaefadb587224eb44d3be0fbb7e2835b48bd7a6\n"
