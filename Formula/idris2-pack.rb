class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.29"
    sha256 cellar: :any, arm64_sequoia: "366557bc983601704b5834ea80d901fddef16e19c3b0dfb61b7c855f73a1fb6d"
    sha256 cellar: :any, arm64_sonoma:  "a39872d590f78ee19e0c3b67c1106acc118cf7b0c5e06492c7a2f585fad39cdc"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260629\n"
