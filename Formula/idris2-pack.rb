class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.26"
    sha256 cellar: :any, arm64_sequoia: "aaf7b22f88a240e50902902cda6b93811a46eb4b09771b8a34998da173af9910"
    sha256 cellar: :any, arm64_sonoma:  "2a81d2bb1f138771a3cd572c1c9e32cd8487f831de352b2b27dcceb0fd9f9a08"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260726\n"
