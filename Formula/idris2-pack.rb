class Idris2Pack < Formula
  ...
  url "https://github.com/stefan-hoeck/idris2-pack/archive/be9725bc108a09a70ebb4b6a40159cc283f38d54.tar.gz"
  version "2026.08.16"
  sha256 "ad17e0d00ec6d07e19bb80fbd0ad047b6074ba8e9857a9cd768104aea47ebd22"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.16"
    sha256 cellar: :any, arm64_sequoia: "b4e442471df443b6b59f5dca07fec23992350c675f50dcda25218fb363279f68"
    sha256 cellar: :any, arm64_sonoma:  "ce1c60cc6214fac0d7f7fc17fe1d4b3d0899dbf3eb9dfb1cf90ea70c09a60fad"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/9b2116d98b5789afe3a003b234fd173c6b9aa379.tar.gz"
    sha256 "cc0b6e7bdd56645bdbe9d89fe5b35566447bf35faef42ebdf0b7bba1ee366f94"
  end
  ...
  resource "idris2-ref1" do
    url "https://github.com/stefan-hoeck/idris2-ref1/archive/d2355c8b51f9f278b82fb4c73547606ba2709a9a.tar.gz"
    sha256 "6ca3b6a78c2db4c028ea524b8271bafba034e8b5c2cdc96d0b725292ecbbc119"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/6c0c590035fdba3a4b6cfaff9dd9deb2791e4aff.tar.gz"
    sha256 "faefcdd3a06e9d57d0099262eff451794158bd3980f199bdd9bb8b722afc1624"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260816\n"
    (libexec/"IDRIS2_COMMIT").write "9b2116d98b5789afe3a003b234fd173c6b9aa379\n"
