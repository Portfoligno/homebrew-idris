class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.03"
    sha256 cellar: :any, arm64_sequoia: "6a88c5bf66b1436162d9eb7b2b207e78921a2813e403a662859469e03adaa244"
    sha256 cellar: :any, arm64_sonoma:  "e41665a57cf5706d2bd8d39e83190494e8a22e596a0fc9175f6c5fdec16f9526"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260903\n"
