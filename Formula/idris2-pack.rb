class Idris2Pack < Formula
  ...
  url "https://github.com/stefan-hoeck/idris2-pack/archive/df1b7d3e8f1b705d181dd9e32751167608489b49.tar.gz"
  version "2026.07.21"
  sha256 "74d78d0f81dfd936b450e3b2c30d65026a224d3646abe6e7b0b507e332048e0f"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.21"
    sha256 cellar: :any, arm64_sequoia: "eafc3f57b698ba7c85363978d709370e1e5b2ecf890a97eb637d23cd2eb7ba91"
    sha256 cellar: :any, arm64_sonoma:  "3393cbe67322e2236b11706f3281da8dfadefedf87482332f7ad83295125aa9a"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/870fcdb81494917f0c302ae1f21c4dbc8e3416c0.tar.gz"
    sha256 "db3691352ac6029032d6082c9b5bda4965d7792637b5ac87031fc46343286884"
  end
  ...
  resource "idris2-ref1" do
    url "https://github.com/stefan-hoeck/idris2-ref1/archive/53ad4c1cafd0ecd756b2b6f7873650c19a28697c.tar.gz"
    sha256 "a333c2888c56dac3ac8760ff1cb5da0693f0278278c0bdbe53bc9d3f832e5f2c"
  end

  resource "idris2-array" do
    url "https://github.com/stefan-hoeck/idris2-array/archive/9ab8faafcbfe40d1cfbc26691faf2d6795c97505.tar.gz"
    sha256 "127236d8094ac1e5ea1516770e09d4afd1fa130ee62534869d507f86231535da"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/b5ad897fdcc4822694c068e5f9a0f995f5483538.tar.gz"
    sha256 "f970b2a3f22f9cb7077a3e4fe9db1a931fc9ebc04c316eeb0b8a0d10077d2a85"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260721\n"
    (libexec/"IDRIS2_COMMIT").write "870fcdb81494917f0c302ae1f21c4dbc8e3416c0\n"
