class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.05"
    sha256 cellar: :any, arm64_sequoia: "0c109e4f3faaefc856732db92a536d13daa0f5c77437931f7d7a2388e7ac6206"
    sha256 cellar: :any, arm64_sonoma:  "1de93c2937a1c80fe0f05ae83507e429d86db7633a12d1ce7fcd7d8cf942ab75"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260705\n"
