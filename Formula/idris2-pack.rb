class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.13"
    sha256 cellar: :any, arm64_sequoia: "fed900730b7a55ab8a577711ca9f0f2a1e276f878183db9daf4017b708160a95"
    sha256 cellar: :any, arm64_sonoma:  "aa1b86106e36a12918d6ba60da50a34dec0c2d2f59ad016a6c630655dd06083d"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/3e6a9e2aa01dd5800af2a8e8f71761d511d25462.tar.gz"
    sha256 "a75beaa6bfd5b4579fa86a9cb63bfeff0a397cb946704e11ddc728630a998a75"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260813\n"
    (libexec/"IDRIS2_COMMIT").write "3e6a9e2aa01dd5800af2a8e8f71761d511d25462\n"
