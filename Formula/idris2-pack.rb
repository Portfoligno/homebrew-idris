class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.20"
    sha256 cellar: :any, arm64_sequoia: "5c4b5ff6e41afe8deecd15d7de389cebf271d34e05f95511232a3eee41abb116"
    sha256 cellar: :any, arm64_sonoma:  "5c2ca8533c1b075183621e6496c1eb677e273e98da5abc17d268faf93198e850"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260820\n"
