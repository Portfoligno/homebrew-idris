class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.12"
    sha256 cellar: :any, arm64_sequoia: "f59ee0f55d3cb5ccfde6c5d22885f3b72683a85a43acca7bf7d55ba122576ee4"
    sha256 cellar: :any, arm64_sonoma:  "0a207efb0c882194a995157993b60147aac0812461092b4703f19acb943e6db1"
  end
  ...
  resource "pack-dep-ilex-core" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/119e247a3c2e9fecc41c2088af4be285dc4c7ee5.tar.gz"
    sha256 "79a553eb11b87dda6dfb33dd24b27bcd33cecf77d55546ed30d9cb9cdb78d469"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260912\n"
