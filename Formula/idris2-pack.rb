class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.08.31"
    sha256 cellar: :any, arm64_sequoia: "48be9cb1f07711b92d5a5143c271739e66e8d8fd9ff1d3e947e9364cda679e72"
    sha256 cellar: :any, arm64_sonoma:  "f0eb5cc45dae6f40ce0943102e34da3a3e7c60ac5e2750b9227b18658629226a"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/84de84efe3140ce4bcb8c981f32afdb9b5060d85.tar.gz"
    sha256 "caa153206a18342cf1b206ecf6b77ba6a234f22a823be97037369057bef6aa83"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260831\n"
    (libexec/"IDRIS2_COMMIT").write "84de84efe3140ce4bcb8c981f32afdb9b5060d85\n"
