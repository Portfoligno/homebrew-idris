class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.26"
    sha256 cellar: :any, arm64_sequoia: "8cc1e282a93edcbc5e9b4d79ba9fd7b9e4871f6418939096246e47e957eceb12"
    sha256 cellar: :any, arm64_sonoma:  "3f906862078e224919d15efc1b138ae28533446330c195ddf2ea415bf0609440"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260926\n"
