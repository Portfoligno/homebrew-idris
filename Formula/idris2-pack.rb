class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.19"
    sha256 cellar: :any, arm64_sequoia: "2d37fef5d75a555a8b0654f8acdb46ae1265f9ac982ef8244289408ebe20ed07"
    sha256 cellar: :any, arm64_sonoma:  "da31858b6ed955af997fd1a1c2d47752491c11951f808b2db3a40ef522e77bae"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/6ca00e72e32849cb35e5c262904e9c3cffc1a9a4.tar.gz"
    sha256 "1dcf7176a06980acc861cfa07d67b79b9ad9892d93ac9df9e071a934df742ab4"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/de44d580a584dfbbc6269a60ec69eac2124d133e.tar.gz"
    sha256 "35d3f905541e1bbe53d8f6c4cbc1cfb7c60bf856be26e39ef4b0c6aace823411"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260619\n"
    (libexec/"IDRIS2_COMMIT").write "6ca00e72e32849cb35e5c262904e9c3cffc1a9a4\n"
