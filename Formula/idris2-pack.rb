class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.18"
    sha256 cellar: :any, arm64_sequoia: "6cae9e4e4e9d359b187713d75ec96a30ee25cc5302b5b7908c3c2cfbf019a36c"
    sha256 cellar: :any, arm64_sonoma:  "e7a8e8f85a735e209c3ce9beb0f07ddeddf5c8110c2444530b9eb8ae93a40300"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260918\n"
