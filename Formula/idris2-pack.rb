class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.12"
    sha256 cellar: :any, arm64_sequoia: "543d918627ffa4aa760c11ff96eb393d369545a1919f59e8d4108623e194d89e"
    sha256 cellar: :any, arm64_sonoma:  "c203666e2ff2ed152bf35c6fc8ef85d288aafea61a86b13ec84d9782e997a27e"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260612\n"
