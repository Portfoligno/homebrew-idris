class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.24"
    sha256 cellar: :any, arm64_sequoia: "b03120d51f60f229ff8c21222c8d7650f1e168f433589570e00b99c8cf4bce0f"
    sha256 cellar: :any, arm64_sonoma:  "e62ade90ff43f550f0a69571d6fc8f8497d9e24204e2b5039996e9a771939cde"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260624\n"
