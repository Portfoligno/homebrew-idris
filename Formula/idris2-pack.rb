class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.17"
    sha256 cellar: :any, arm64_sequoia: "af20d25c0ef56b18d1c235cc356894ae78564b782384bbbe0a9c6541715f67e4"
    sha256 cellar: :any, arm64_sonoma:  "6c6207041383e641794b9b8e7da00a489235e94f24b69338784403eddb6df21b"
  end
  ...
  resource "pack-dep-ilex-core" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/09a88144c46a03b6316946df9abb5ea729c15a79.tar.gz"
    sha256 "86e525f1f2a7a3e0de83362d8ea10c4ee20eade6ff2aced8260769708c8bc869"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260917\n"
