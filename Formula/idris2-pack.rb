class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.29"
    sha256 cellar: :any, arm64_sequoia: "d9aafe36c8b71a5fcf880364c45817136f9726e1f5c36fefe72d29290f7ef421"
    sha256 cellar: :any, arm64_sonoma:  "6b6ee423f82d3de68d6bbabd7aac9f6ed59e742689dc0375881cae80f63a944a"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260729\n"
