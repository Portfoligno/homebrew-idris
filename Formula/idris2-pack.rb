class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.19"
    sha256 cellar: :any, arm64_sequoia: "2f6e0723cd25931a3523bc3cde6ade9476b22ff5141c0dee6d016b497ec4955e"
    sha256 cellar: :any, arm64_sonoma:  "846135a522e5755b8b29c15c2b3158e69131cdf2d7de8668504874ca797aea9f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260919\n"
