class Idris2Pack < Formula
  ...
  def install
    ...
    %w[idris2-algebra idris2-ref1 idris2-array idris2-bytestring idris2-getopts idris2-elab-util idris2-refined
       idris2-literal idris2-filepath].each do |lib_name|
