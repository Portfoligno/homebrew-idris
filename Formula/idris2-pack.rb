class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.01"
    sha256 cellar: :any, arm64_sequoia: "65a54cae1eef70722b4e3e202d306107175897a24c947df5cb54d70cff769995"
    sha256 cellar: :any, arm64_sonoma:  "1d39a28217432f593c6be9959b963652730c97980efa09270e222c08e8acc3ab"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260701\n"
