class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.06.13"
    sha256 cellar: :any, arm64_sequoia: "d95b865df55cfc09db371f149f55901dd8caf85f8ea392812ef022d85df87923"
    sha256 cellar: :any, arm64_sonoma:  "408938ca559b2a5c4b486bc32f759d2b8cb76147ced2d79526528b6ba67b1b42"
  end
  ...
  resource "idris2-ilex" do
    url "https://github.com/stefan-hoeck/idris2-ilex/archive/88f643745ec7ad8180e18ede2ee0592b1d1e744e.tar.gz"
    sha256 "6c549082e0cbd816610e1a3e5c4bcb8760ba248a2cfdfe8d0dac5094be166162"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260613\n"
