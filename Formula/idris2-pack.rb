class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.07.11"
    sha256 cellar: :any, arm64_sequoia: "386f2fe537954f4c5bb129a62de70e0d48f71eaad12922dabecba478d0050c0f"
    sha256 cellar: :any, arm64_sonoma:  "e267ba0fcce2dd53c2eaeb88df8449bce0f9d3dca82b3c587fc17b8219fb4d24"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260711\n"
