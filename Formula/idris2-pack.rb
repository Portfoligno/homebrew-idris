class Idris2Pack < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.09.02"
    sha256 cellar: :any, arm64_sequoia: "5a373e9009307867835e10321b499177156a22b65900e981e8f54b509fa80c2f"
    sha256 cellar: :any, arm64_sonoma:  "cb5f4b1a34a82e70cafb662b5e622c1b96896cb84ef9f578d90e8f6664a80d43"
  end
  ...
  resource "idris2-array" do
    url "https://github.com/stefan-hoeck/idris2-array/archive/e5870d49b995fd672a6b6c33190223ecfde48477.tar.gz"
    sha256 "0535b385fd49d41da1299dd342c237a1a0be346db8c31364b7beb5a6afb2fcfb"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260902\n"
