class Idris2PackAT20260525 < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.05.25"
    sha256 cellar: :any, arm64_sequoia: "372deda53b7db7f366a1f50618e748d5b57485eea8585e0d2b59dba458fbd4c8"
    sha256 cellar: :any, arm64_sonoma:  "6e7ee334065b90f0fb4c3bb0bf05696835f93340e52a43df772445b171e9edea"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/6a54860ee748accc1a2be1da4a77727b5be4c1dc.tar.gz"
    sha256 "ed7ae919ea0bd24222bf9588480933847d0baffbc36c4b165a49206361594737"
  end
  ...
  def install
    ...
    (libexec/"IDRIS2_COMMIT").write "6a54860ee748accc1a2be1da4a77727b5be4c1dc\n"
