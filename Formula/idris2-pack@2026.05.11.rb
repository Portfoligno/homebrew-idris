class Idris2PackAT20260511 < Formula
  desc "Package manager for the Idris 2 programming language"
  homepage "https://github.com/stefan-hoeck/idris2-pack"

  url "https://github.com/stefan-hoeck/idris2-pack/archive/994d7a31050654cfd1a79f33cad4b0e97a37d38e.tar.gz"
  version "2026.05.11"
  sha256 "3a684bd9e72266a68e1e9e3b88837cb94cbd86dc3a313729c5235069d5ffa5a4"
  license "BSD-3-Clause"

  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.05.11"
    sha256 cellar: :any, arm64_sequoia: "f3324aff9174ef4c44a608f10028e1090966e9b07990608b0da070362380bedd"
    sha256 cellar: :any, arm64_sonoma:  "8e6f5efe71407d58f4473c73678bceae63c82e2f81e0f3e6fdbd48637d4f0205"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/b61f0ac790559c018b34a764455642f606789249.tar.gz"
    sha256 "16049003d8af826dc67ad5f48af53001362a1848dd8b252b1fd1d1ad0a51df8d"
  end
  ...
  def install
    ...
    (libexec/"IDRIS2_COMMIT").write "b61f0ac790559c018b34a764455642f606789249\n"
