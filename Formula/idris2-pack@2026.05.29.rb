class Idris2PackAT20260529 < Formula
  ...
  bottle do
    root_url "https://github.com/Portfoligno/homebrew-idris/releases/download/idris2-pack-2026.05.29"
    sha256 cellar: :any, arm64_sequoia: "096deb99ae0b8aabf97f567cfcde8c5c347f87cf60367a6d569f99f2db721876"
    sha256 cellar: :any, arm64_sonoma:  "13d2c66590735aff64ca2ed05cd523bd10e4e9c20b08234e8a8321a95b523922"
  end
  ...
  resource "idris2" do
    url "https://github.com/idris-lang/Idris2/archive/a286fcadb237ba21e0a49f76d154e77387827e58.tar.gz"
    sha256 "6ca78e197869734bf3a5a7b14fd0e7a774645ce3460a447f190d9c7756e0a60f"
  end
  ...
  def install
    ...
    (libexec/"COLLECTION").write "nightly-260529\n"
    (libexec/"IDRIS2_COMMIT").write "a286fcadb237ba21e0a49f76d154e77387827e58\n"
